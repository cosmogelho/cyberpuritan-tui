use super::{
    ...
    piedade_dashboard::PiedadeDashboardComponent, salmo_view::SalmoViewComponent, Action,
    Component, Module,
};
...
impl Component for SalterioListComponent {
    ...
    fn handle_key_events(&mut self, key: KeyEvent, app: &mut App) -> Option<Action> {
        ...
        match key.code {
            ...
            KeyCode::Char('2') => return Some(Action::Navigate(Box::new(PiedadeDashboardComponent::new()))),
